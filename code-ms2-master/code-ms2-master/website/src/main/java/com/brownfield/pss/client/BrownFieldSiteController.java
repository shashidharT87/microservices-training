...
public class BrownFieldSiteController {
	...
	public String greetingSubmit(@ModelAttribute UIData uiData, Model model) {
		...
		Flight[] flights = restClient.postForObject("http://search-service/search/get", uiData.getSearchQuery(),
				Flight[].class);
//		Flight[] flights = restClient.postForObject("http://apigateway/search-api/search/get", uiData.getSearchQuery(),
//				Flight[].class);
